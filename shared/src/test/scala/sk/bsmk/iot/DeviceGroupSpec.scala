...
import sk.bsmk.iot.Device.{Passivate, RecordTemperature, TemperatureRecorded}
import sk.bsmk.iot.DeviceGroup.{RequestAllTemperatures, RespondAllTemperatures, Temperature, TemperatureNotAvailable}
